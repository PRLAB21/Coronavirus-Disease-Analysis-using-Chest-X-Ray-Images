...
model_path = 'models/net_RENet_VGG_Modified2.mat';
if isfile(model_path)
    fprintf("Model loading...\n");
    load(model_path,'net_RENet_VGG_Modified2');
    ...
    if (~cancel)
        ...
        [predicted_labels,posterior] = classify(net_RENet_VGG_Modified2,resized_image);
        fprintf("posterior: %f\n", posterior);
